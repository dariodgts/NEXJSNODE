...
//mostrando las vistas de las paginas recargadas
app.get("/", (req, res)=>res.render("index.ejs",{inicio:"inicio"}))/*para que me llegue a la ruta del index desde el puerto 5000 */
app.get("/inicio", (req, res)=>res.render("index.ejs",{inicio:"inicio"}))    /* enviando archivos del frontend al backend y navegar en las paginas ejs desde web */
app.get("/acerca", (req, res)=>res.render("acerca.ejs",{acerca:"acerca"}))
app.get("/servicios", (req, res)=>res.render("servicios.ejs",{servicios:"servicios"}))
app.get("/contacto", (req, res)=>res.render("contacto.ejs",{contacto:"contacto"}))
